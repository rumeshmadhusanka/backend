...
interface IServiceStation{
    public function run();
}
class ServiceStation implements IServiceStation
{
    public function run()
    {
...
//login display
    ...
    private function getServiceStationDetails()
    {
    ...
    private function updateServiceStation()
    {
        Utilities::verifyLogIn("SERVICE_CENTER");
        $sId = $_SESSION['s_id'];
////simulation--------------------------------------------
...
//update result
    ...
    private function showSalesStatus()
...
class ServiceStationProxy implements IServiceStation{
    private $station;
    private $logger;

    public function __construct()
    {
        $this->station= new ServiceStation();
